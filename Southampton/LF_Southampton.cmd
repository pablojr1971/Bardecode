...
set "_LF_DrasS_Path=C:\2003-Southampton\Drawings as Scanned"
...
C:\mydoc\Southampton\inifile\INIFILE "LF_Southampton.ini" [options] inputFolder=System.String,C:\2003-Southampton\Drawings as Scanned\!_LF_DrasS_Folder!
...
C:\mydoc\Southampton\inifile\INIFILE "LF_Southampton.ini" [options] inputFolder==
...
for /F "tokens=1,2 delims=_" %%D in ('dir /B *.pdf') do (
	...
	if "!last!" neq "%%D" (
		...
		if defined list (
		call %~dp0\sejda-console-2.0.0.M1\bin\sejda-console.bat merge -f !list:~1! -o !last!.pdf
		del !list:~1!
		)
		set "list="
		set "last=%%D"
